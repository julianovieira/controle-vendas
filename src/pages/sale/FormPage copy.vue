          ...
          <div class="row q-gutter-md">
            <div>
              <div class="q-gutter-sm">
                ...
                <div class="flex q-gutter-sm" style="display: flex; align-items: center;">
                  <q-select
                    filled
                    standout
              ...
              <div class="flex justify-between q-gutter-md q-mt-sm">
            ...
            <div class="row q-gutter-sm" style="display: flex; justify-content: center;">
              <div class="q-gutter-sm">
                <div class="text-center text-bold">Selecione Cliente</div>
                <q-select
                  filled
                  standout
                  placeholder="Selecionar"
              ...
              <div class="q-gutter-sm">
                <div class="text-center text-bold">Forma de Pagamento</div>
